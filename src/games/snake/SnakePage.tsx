...
export default function SnakePage() {
  ...
  useEffect(() => {
    ...
    ctx.shadowBlur = 16
    ctx.fillRect(fc * CELL_SIZE + 2, fr * CELL_SIZE + 2, CELL_SIZE - 4, CELL_SIZE - 4)
    ctx.shadowBlur = 0
        ...
        <div className={styles.rightPanel}>
          <div className={styles.controls}>
            ...
            <ul className={styles.controlsList}>
              <li><kbd>← → ↑ ↓</kbd> Move</li>
              <li><kbd>WASD</kbd> Also move</li>
              <li><kbd>P</kbd> Pause</li>
              <li><kbd>ENTER</kbd> Start/Restart</li>
            </ul>
          </div>

          <div className={styles.tip}>
            <p className={styles.tipTitle}>TIP</p>
            <p className={styles.tipText}>Speed increases every {5} foods eaten!</p>
          </div>
